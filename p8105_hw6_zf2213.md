...
``` r
birthweight_lm[[1]] %>% summary() %>% broom::tidy() %>% knitr::kable()
```

| term        |      estimate |  std.error |   statistic |   p.value |
| :---------- | ------------: | ---------: | ----------: | --------: |
| (Intercept) | \-5793.517257 | 97.5141826 | \-59.412048 | 0.0000000 |
| bhead       |    132.197131 |  3.4336341 |   38.500646 | 0.0000000 |
| blength     |     74.793122 |  2.0198949 |   37.028224 | 0.0000000 |
| mracewhite  |    138.120737 |  8.8801240 |   15.553920 | 0.0000000 |
| delwt       |      3.502490 |  0.2803006 |   12.495475 | 0.0000000 |
| gaweeks     |     11.617476 |  1.4559237 |    7.979454 | 0.0000000 |
| smoken      |    \-4.841831 |  0.5858388 |  \-8.264784 | 0.0000000 |
| ppbmi       |   \-12.185915 |  1.9028329 |  \-6.404091 | 0.0000000 |
| babysexmale |   \-29.003909 |  8.4510671 |  \-3.431982 | 0.0006048 |
...
predefined alpha level, return the model and selection history.
...
baby’s head circumference (cm) baby’s birth length (cm) mother’s race …

Model \#2:

baby’s head circumference (cm), baby’s length (cm), baby’s sex

Model \#3:

baby’s length (cm), gestational age (week)
